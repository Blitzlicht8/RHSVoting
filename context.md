# Project Context — RHSVoting (Community Platform)
...
A general-purpose community/org voting and feed platform built on Next.js 14. Originally a school voting app — fully de-schooled. Deployed on Vercel, DB on Turso (SQLite).
...
2. **Bump version** in `package.json` — pick MAJOR/MINOR/FIX
